...
!function(t,i,e,n){function s(i,e){this.$element=i,this.options=t.extend({},o,e),this._defaults=o,this.init()}var o={orientation:"left",mode:"push","static":!1};s.prototype.init=function(){var i=this;if(0==t("#slidepanel").length){var e='<div id="slidepanel" class="cb_slide_panel"><div class="wrapper"><a href="#" class="close">Close</a><div class="inner"><div class="wrapper"></div></div></div></div>';t(e).hide().appendTo(t("body"))}if(this.$panel=t("#slidepanel"),this.$body=t("body"),this.$body_position=this.$body.css("position"),this.$panel.hide().addClass("panel_"+this.options.orientation),this.$panel.data("slidepanel-current",!1),this.$panel.data("slidepanel-loaded",!1),this.$panel.css("left","").css("right","").css("top","").css("bottom",""),"left"==this.options.orientation||"right"==this.options.orientation){var n={};n.top=0,n[this.options.orientation]=-this.$panel.width(),this.$panel.css(n)}if("top"==this.options.orientation||"bottom"==this.options.orientation){var n={};n.left=0,n[this.options.orientation]=-this.$panel.height(),this.$panel.css(n)}t(this.$element).on("click",function(t){t.preventDefault(),i.options["static"]?i.expand():i.load()}),t(".close",this.$panel).click(function(t){t.preventDefault(),i.collapse()})},s.prototype.load=function(){var i=this;if(this.$panel.data("slidepanel-current")==this.$element)return void this.collapse();this.expand();var e=t(this.$element).attr("href");this.$panel.data("slidepanel-loaded")!==e?t(".inner .wrapper",this.$panel).html("").load(e,function(){i.$panel.removeClass("loading"),i.$panel.data("slidepanel-loaded",e)}):this.$panel.removeClass("loading"),this.$panel.data("slidepanel-current",this.$element)},s.prototype.expand=function(){var i=this,e={},n={};e.visible="show",e[this.options.orientation]=0,n[this.options.orientation]="top"==this.options.orientation||"bottom"==this.options.orientation?this.$panel.height():this.$panel.width(),"push"==this.options.mode&&this.$body.css("position","absolute").animate(n,250),this.$panel.addClass("loading").animate(e,250,function(){t(".close",i.$panel).fadeIn(250)})},s.prototype.collapse=function(){t(".close",this.$panel).hide();var i={},e={};i.visible="hide",i[this.options.orientation]=-(this.$panel.width()+40),e[this.options.orientation]=0,"push"==this.options.mode&&this.$body.css("position",this.$body_position).animate(e,250),this.$panel.animate(i,250).data("slidepanel-current",!1)},t.fn.slidepanel=function(i){return this.each(function(){t.data(this,"plugin_slidepanel")||t.data(this,"plugin_slidepanel",new s(this,i))})}}(jQuery,window);
